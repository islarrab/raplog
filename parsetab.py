...
_lr_signature = '\xb0\x06i\xf6_2s\x8apz\xd5|\x89\xee\x89\x11'
...
_lr_productions = [
  ...
  ('new_scope -> <empty>','new_scope',0,'p_new_scope','parser.py',123),
  ('add_proc_main -> <empty>','add_proc_main',0,'p_add_proc_main','parser.py',127),
  ...
  ('raplog -> empty','raplog',1,'p_raplog','parser.py',139),
  ('function -> ID add_proc defparams statements-block','function',4,'p_function','parser.py',142),
  ('statements-block -> LCURLY new_scope statements RCURLY','statements-block',4,'p_statements_block','parser.py',146),
  ('statements -> statement statements','statements',2,'p_statements','parser.py',150),
  ('statements -> empty','statements',1,'p_statements','parser.py',151),
  ('statement -> assignment','statement',1,'p_statement','parser.py',154),
  ('statement -> call','statement',1,'p_statement','parser.py',155),
  ('statement -> input','statement',1,'p_statement','parser.py',156),
  ('statement -> output','statement',1,'p_statement','parser.py',157),
  ('statement -> selection','statement',1,'p_statement','parser.py',158),
  ('statement -> loop','statement',1,'p_statement','parser.py',159),
  ('assignment -> ID EQ expression','assignment',3,'p_assignment','parser.py',162),
  ('assignment -> ID EQ array','assignment',3,'p_assignment','parser.py',163),
  ('call -> ID callparams','call',2,'p_call','parser.py',167),
  ('input -> GET ID','input',2,'p_input','parser.py',172),
  ('output -> PUT expression','output',2,'p_output','parser.py',175),
  ('selection -> IF expression statements-block','selection',3,'p_selection','parser.py',178),
  ('selection -> IF expression statements-block ELSE statements-block','selection',5,'p_selection','parser.py',179),
  ('loop -> LOOP expression statements-block','loop',3,'p_loop','parser.py',182),
  ('defparams -> LPAREN defparams1 RPAREN','defparams',3,'p_defparams','parser.py',185),
  ('defparams -> LPAREN RPAREN','defparams',2,'p_defparams','parser.py',186),
  ('defparams1 -> param_type ID','defparams1',2,'p_defparams1','parser.py',189),
  ('defparams1 -> param_type ID COMA defparams1','defparams1',4,'p_defparams1','parser.py',190),
  ('param_type -> IN','param_type',1,'p_param_type','parser.py',196),
  ('param_type -> OUT','param_type',1,'p_param_type','parser.py',197),
  ('callparams -> LPAREN callparams1 RPAREN','callparams',3,'p_callparams','parser.py',200),
  ('callparams1 -> expression callparams2','callparams1',2,'p_callparams1','parser.py',203),
  ('callparams1 -> empty','callparams1',1,'p_callparams1','parser.py',204),
  ('callparams2 -> COMA expression callparams2','callparams2',3,'p_callparams2','parser.py',207),
  ('callparams2 -> empty','callparams2',1,'p_callparams2','parser.py',208),
  ('varcte -> INT','varcte',1,'p_varcte_constant','parser.py',211),
  ('varcte -> FLOAT','varcte',1,'p_varcte_constant','parser.py',212),
  ('varcte -> STR','varcte',1,'p_varcte_constant','parser.py',213),
  ('varcte -> ID','varcte',1,'p_varcte_id','parser.py',217),
  ('varcte -> ID array_index','varcte',2,'p_varcte_id','parser.py',218),
  ('expression -> expression AND expression','expression',3,'p_expression_boolean','parser.py',226),
  ('expression -> expression OR expression','expression',3,'p_expression_boolean','parser.py',227),
  ('expression -> NOT expression','expression',2,'p_expression_boolean','parser.py',228),
  ('expression -> expression EQEQ expression','expression',3,'p_expression_comparison','parser.py',231),
  ('expression -> expression NE expression','expression',3,'p_expression_comparison','parser.py',232),
  ('expression -> expression LT expression','expression',3,'p_expression_comparison','parser.py',233),
  ('expression -> expression MT expression','expression',3,'p_expression_comparison','parser.py',234),
  ('expression -> expression LTEQ expression','expression',3,'p_expression_comparison','parser.py',235),
  ('expression -> expression MTEQ expression','expression',3,'p_expression_comparison','parser.py',236),
  ('expression -> expression PLUS expression','expression',3,'p_expression_arithmetic','parser.py',239),
  ('expression -> expression MINUS expression','expression',3,'p_expression_arithmetic','parser.py',240),
  ('expression -> expression TIMES expression','expression',3,'p_expression_arithmetic','parser.py',241),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_arithmetic','parser.py',242),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',245),
  ('expression -> PLUS expression','expression',2,'p_expression_uplus','parser.py',249),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','parser.py',253),
  ('expression -> varcte','expression',1,'p_expression_element','parser.py',257),
  ('array_index -> LBRACK expression RBRACK','array_index',3,'p_array_index','parser.py',261),
  ('array_index -> LBRACK expression RBRACK array_index','array_index',4,'p_array_index','parser.py',262),
  ('array -> LBRACK array_elements RBRACK','array',3,'p_array','parser.py',268),
  ('array -> LBRACK RBRACK','array',2,'p_array','parser.py',269),
  ('array_elements -> expression','array_elements',1,'p_array_elements','parser.py',272),
  ('array_elements -> expression COMA array_elements','array_elements',3,'p_array_elements','parser.py',273),
